...
internal enum Strings {
  ...
  internal static let extractOtpErrorMessage = Strings.tr("Localizable", "_extractOtpErrorMessage", fallback: "An error occurred while searching for a QR code.")
  ...
  internal static let reportAnIssue = Strings.tr("Localizable", "_reportAnIssue", fallback: "Report an Issue")
