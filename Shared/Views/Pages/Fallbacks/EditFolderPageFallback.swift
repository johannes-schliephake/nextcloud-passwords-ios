...
struct EditFolderPageFallback: View { /// This insanely dumb workaround (duplicated view) prevents a crash on iOS 14 when an attribute is marked with `@available(iOS 15, *) @FocusState`
...
struct EditFolderPageFallbackPreview: PreviewProvider {
    
    static var previews: some View {
        PreviewDevice.generate {
            NavigationView {
                EditFolderPageFallback(folder: Folder.mocks.first!, folders: Folder.mocks, addFolder: {}, updateFolder: {})
            }
            .showColumns(false)
        }
    }
