...
struct SelectTagsPageFallbackPreview: PreviewProvider {
    
    static var previews: some View {
        PreviewDevice.generate {
            NavigationView {
                SelectTagsPageFallback(entriesController: EntriesController.mock, temporaryEntry: .password(label: Password.mock.label, username: Password.mock.username, url: Password.mock.url, tags: Password.mock.tags), selectTags: { _, _  in })
            }
            .showColumns(false)
        }
    }
