...
class LogicTests: XCTestCase {
    ...
    func test_urlScoreSearchUrl() {
        ...
        XCTAssertEqual(0.8, URL(string: "https://cloud.example.com")!.score(searchUrl: URL(string: "https://cloud.example.com/index.php/login?redirect_url=/index.php/apps/files")!), accuracy: 0.05)
